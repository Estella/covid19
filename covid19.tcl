#######################################################################################################
## Covid19.tcl 1.1  (18/03/2020)          Copyright 2008 - 2020 @ WwW.TCLScripts.NET ##
...
proc corona:extract {data country total} {
  ...
  #regsub -all -nocase $var $data "" text
  regexp -nocase $var $data text
  # putlog "DEBUG: $text"
  # country,total,new,tdeath,ndeath,recovered,active,serious,pop
