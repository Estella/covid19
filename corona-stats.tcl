...
bind pub - !vx ::CovidStats::pubGetStats
bind pub - !vx5 ::CovidStats::pubGetTop5Stats
...
if {[array size ::CovidStats::countryMapping] > 0} {
    foreach k [array names ::CovidStats::countryMapping] {
        ...
        set cmd [concat $cmd "}"]
        eval $cmd
        bind pub - !vx-${k} ::CovidStats::${k}getStats
    }
}
...
if {[array size ::CovidStats::usStatesMapping] > 0} {
    foreach k [array names ::CovidStats::usStatesMapping] {
        ...
        set cmd [concat $cmd "}"]
        eval $cmd
        bind pub - !vx-us-${k} ::CovidStats::${k}UsStatesGetStats
    }
}
...
if {[array size ::CovidStats::caProvincesMapping] > 0} {
    foreach k [array names ::CovidStats::caProvincesMapping] {
        ...
        set cmd [concat $cmd "}"]
        eval $cmd
        bind pub - !vx-ca-${k} ::CovidStats::${k}CaProvinceGetStats
    }
}
...
proc CovidStats::formatOutput { data } {
    ...
    dict for {key value} $data {
        ...
        if {$key == "updated"} {
            ...
            dict for {k v} $value {
              set k1 [::CovidStats::readableText $k]
              if {($k1 == "Cases") || ($k1 == "Confirmed")} {
                append res "- $k1:\00307 $v \003"
              } elseif {$k1 == "Today Cases"} {
                append res "- $k1:\00308 $v \003"
              } elseif {($k1 == "Deaths") || ($k1 == "Deaths Per One Million")} {
                append res "- $k1:\00304 $v \003"
              } elseif {$k1 == "Recovered"} {
                append res "- $k1:\00303 $v \003"
              } elseif {$k1 == "Active"} {
                append res "- $k1:\00313 $v \003"
              } elseif {($k1 == "Updated") || ($k1 == "Cases Per One Million") || ($k1 == "Updated At")} {
                append res "- $k1:\00311 $v \003"
              } elseif {($k1 == "Affected Countries") || ($k1 == "Critical")} {
                append res "- $k1:\00305 $v \003"
              } elseif {$k1 == "Today Deaths"} {
                append res "- $k1:\00305 $v \003"
              } elseif {$k1 == "Province"} {
                append res "- $k1:\00312 $v \003"
              } else {
                append res "- $k1: $v "
              }
            }
              ...
              if {($k1 == "Cases") || ($k1 == "Confirmed")} {
                append res "- $k1:\00307 $value \003"
              } elseif {$k1 == "Today Cases"} {
                append res "- $k1:\00308 $value \003"
              } elseif {($k1 == "Deaths") || ($k1 == "Deaths Per One Million")} {
                append res "- $k1:\00304 $value \003"
              } elseif {$k1 == "Recovered"} {
                append res "- $k1:\00303 $value \003"
              } elseif {$k1 == "Active"} {
                append res "- $k1:\00313 $value \003"
              } elseif {($k1 == "Updated") || ($k1 == "Cases Per One Million") || ($k1 == "Updated At")} {
                append res "- $k1:\00311 $value \003"
              } elseif {($k1 == "Affected Countries") || ($k1 == "Critical")} {
                append res "- $k1:\00305 $value \003"
              } elseif {$k1 == "Today Deaths"} {
                append res "- $k1:\00305 $value \003"
              } elseif {$k1 == "Province"} {
                append res "- $k1:\00312 $value \003"
              } else {
                append res "- $k1: $value "
              }
        }
